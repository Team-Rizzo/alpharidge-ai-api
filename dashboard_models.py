...
# ============================================================================
# Event & Narrative Response Models
# ============================================================================


class EventSummary(BaseModel):
    """Summary of a canonical event for dashboard/chart display."""
    id: int
    event_type: str
    canonical_title: str
...
class EventsResponse(BaseModel):
    """Response for GET /dashboard/events."""
    events: List[EventSummary]
    total: int


class EventDetailResponse(BaseModel):
    """Response for GET /dashboard/events/{id}."""
    event: EventSummary
    articles: List[dict]
...
class NarrativesResponse(BaseModel):
    """Response for GET /dashboard/narratives."""
    narratives: List[NarrativeSummary]
    total: int


class NarrativeIntensityPoint(BaseModel):
    """Single data point for narrative time series."""
    date: str
    article_count: int = 0
    avg_sentiment: Optional[float] = None


class NarrativeTimeSeriesResponse(BaseModel):
    """Response for GET /dashboard/narratives/{id}/sentiment."""
    narrative_id: int
    narrative_name: str
    data: List[NarrativeIntensityPoint]
