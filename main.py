...
SUBNET_CONFIG = {
    ...
    "DISPATCH_MODE": os.getenv("SUBNET_DISPATCH_MODE", "coverage"),
    "DISPATCH_CREDIT_SHADOW": os.getenv("SUBNET_DISPATCH_CREDIT_SHADOW", "false").lower() == "true",
    "DISPATCH_SPEED_BONUS": float(os.getenv("SUBNET_DISPATCH_SPEED_BONUS", "0.0")),
    "DISPATCH_QUALITY_GATE_Z": float(os.getenv("SUBNET_DISPATCH_QUALITY_GATE_Z", "3.0")),
    "TRIAGE_RELEVANCE_BOUND": float(os.getenv("SUBNET_TRIAGE_RELEVANCE_BOUND", "2.0")),
    "TRIAGE_RELEVANCE_AUDIT_N": int(os.getenv("SUBNET_TRIAGE_RELEVANCE_AUDIT_N", "1")),
    "TRIAGE_RELEVANCE_AUDIT_TOL": float(os.getenv("SUBNET_TRIAGE_RELEVANCE_AUDIT_TOL", "0.06")),
