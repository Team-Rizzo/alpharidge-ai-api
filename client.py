...
Usage:
    ...
    # Get telegram messages to score (with context for classification)
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        async with TalismanAPIClient(
            ...
            # Get unscored telegram messages
            print("\nGetting unscored telegram messages...")
            messages = await client.get_unscored_telegram_messages(limit=3)
            ...
            # Example: Submit completed telegram messages (uncomment to use)
            # if messages:
            #     completed = [
            #         {
            #             "message_id": msg.id,
            ...
            #         for msg in messages
            #     ]
            #     result = await client.submit_completed_telegram_messages(completed)
            #     print(f"Submitted: {result.message}")
